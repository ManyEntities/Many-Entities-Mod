...
public class RenderEnergyBall extends Render{
    ...
    public RenderEnergyBall(float p_i1254_1_)
    {
     ...
     */
    public void doRender(LargeEnergyBall p_76986_1_, double p_76986_2_, double p_76986_4_, double p_76986_6_, float p_76986_8_, float p_76986_9_)
    {
        GL11.glPushMatrix();
        ...
        IIcon iicon = MEItems.itemenergyball.getIconFromDamage(0);
     ...
     */
   protected ResourceLocation getEntityTexture(LargeEnergyBall p_110775_1_)
    {
    ...
    {
        return this.getEntityTexture((LargeEnergyBall)p_110775_1_);
    }
    ...
    {
        this.doRender((LargeEnergyBall)p_76986_1_, p_76986_2_, p_76986_4_, p_76986_6_, p_76986_8_, p_76986_9_);
    }
}
