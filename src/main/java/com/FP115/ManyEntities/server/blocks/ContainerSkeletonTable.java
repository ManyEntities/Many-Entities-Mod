...
public class ContainerSkeletonTable extends Container
{
    ...
    public ContainerSkeletonTable(InventoryPlayer player, TileEntitySkeletonTable p_i1812_2_)
    {
        this.tileFurnace = p_i1812_2_;
        this.addSlotToContainer(new Slot(p_i1812_2_, 0, 121, 55));//121, 55
        this.addSlotToContainer(new Slot(p_i1812_2_, 1, 40, 55));//80, 16
        this.addSlotToContainer(new SlotFurnace(player.player, p_i1812_2_, 2, 80, 16));//40, 55
        int i;
    ...
    public ItemStack transferStackInSlot(EntityPlayer p_82846_1_, int p_82846_2_)
    {
        ...
        if (slot != null && slot.getHasStack())
        {
            ...
            {
                if (SkeletonTableRecipes.smelting().getSmeltingResult(itemstack1) != null)
                {
                ...
                else if (TileEntitySkeletonTable.isItemFuel(itemstack1))
                {
