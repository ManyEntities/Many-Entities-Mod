...
public class CrystallizerContainer extends Container{
	private TileEntityCrystallizer tileFurnace;
    private int lastCookTime;
    private int lastBurnTime;
    private int lastItemBurnTime;
    private static final String __OBFID = "CL_00001748";

    public CrystallizerContainer(InventoryPlayer player, TileEntityCrystallizer p_i1812_2_)
    {
    ...
    public ItemStack transferStackInSlot(EntityPlayer p_82846_1_, int p_82846_2_)
    {
        ...
        if (slot != null && slot.getHasStack())
        {
            ...
            {
                if (CrystallizerRecipes.smelting().getSmeltingResult(itemstack1) != null)
                {
