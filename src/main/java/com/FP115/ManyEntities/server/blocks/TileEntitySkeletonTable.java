...
import com.FP115.ManyEntities.server.blocks.SkeletonTable;
import com.FP115.ManyEntities.server.blocks.SkeletonTableRecipes;
...
public class TileEntitySkeletonTable extends TileEntity implements ISidedInventory
{
    ...
    public void updateEntity()
    {
        ...
        if (!this.worldObj.isRemote)
        {
            ...
            {
                flag1 = true;
                SkeletonTable.updateFurnaceBlockState(this.furnaceBurnTime > 0, this.worldObj, this.xCoord, this.yCoord, this.zCoord);
            }
        }
    ...
    private boolean canSmelt()
    {
        ...
        {
            ItemStack itemstack = SkeletonTableRecipes.smelting().getSmeltingResult(this.furnaceItemStacks[0]);
    ...
    public static int getItemBurnTime(ItemStack p_145952_0_)
    {
        ...
        else
        {
            ...
            if (item == MEItems.darkessense) return 200;
            else return 0;
        }
    }
	...
	public void setInventorySlotContents(int slotID, ItemStack itemStack) {
		furnaceItemStacks[slotID] = itemStack;
	}
	...
	public ItemStack getStackInSlot(int slotID) {
		return furnaceItemStacks[slotID];
	}
