...
public abstract class EnergyBall extends Entity{
    ...
    public EnergyBall(World p_i1759_1_)
    {
        super(p_i1759_1_);
    ...
    public EnergyBall(World p_i1760_1_, double p_i1760_2_, double p_i1760_4_, double p_i1760_6_, double p_i1760_8_, double p_i1760_10_, double p_i1760_12_)
    {
        super(p_i1760_1_);
        this.setSize(1.0F, 1.0F);
    ...
    public EnergyBall(World p_i1761_1_, EntityLivingBase p_i1761_2_, double p_i1761_3_, double p_i1761_5_, double p_i1761_7_)
    {
        super(p_i1761_1_);
