...
public class AbstractGuiTrader extends GuiContainer{
    ...
    public AbstractGuiTrader(AbstractTraderContainer container, IMerchant mer, String name)
    {
        super(container);
        this.field_147037_w = mer;
        this.name = name;
    ...
    public void initGui()
    {
        ...
        this.buttonList.add(this.field_147043_x = new  AbstractGuiTrader.MerchantButton(1, i + 120 + 27, j + 24 - 1, true));
        this.buttonList.add(this.field_147042_y = new  AbstractGuiTrader.MerchantButton(2, i + 36 - 19, j + 24 - 1, false));
    ...
    protected void drawGuiContainerBackgroundLayer(float p_146976_1_, int p_146976_2_, int p_146976_3_)
    {
        ...
        this.mc.getTextureManager().bindTexture(new ResourceLocation("manyentities:textures/gui/"+name+".png"));
    ...
    static class MerchantButton extends GuiButton
        {
            ...
            public void drawButton(Minecraft p_146112_1_, int p_146112_2_, int p_146112_3_)
            {
                if (this.visible)
                {
                    p_146112_1_.getTextureManager().bindTexture(new ResourceLocation("manyentities:textures/gui/"+name+".png"));
                    GL11.glColor4f(1.0F, 1.0F, 1.0F, 1.0F);
