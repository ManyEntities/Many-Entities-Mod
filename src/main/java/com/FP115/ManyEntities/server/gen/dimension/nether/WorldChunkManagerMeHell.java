...
public class WorldChunkManagerMeHell extends WorldChunkManager{
	...
	protected WorldChunkManagerMeHell()
	{
		biomeCache = new BiomeCache(this);
		biomesToSpawnIn = new ArrayList<BiomeGenBase>();
	}

	public WorldChunkManagerMeHell(long par1, WorldType par3WorldType)
	{
		this();
		GenLayer[] var4 = HellGenLayer.initializeAllBiomeGenerators(par1, par3WorldType, -1);//.initializeAllBiomeGenerators(par1, par3WorldType);
		genBiomes = var4[0];
		biomeIndexLayer = var4[1];
	}

	public WorldChunkManagerMeHell(World par1World)
	{
